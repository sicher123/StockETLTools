...
from datasync.data_origin import *
from datasync.dataReceiver import *
...
class Updater(object):
    ...
    def __call__(self, db, view, df, **kargs):
        ...
        if view in min_views:
            self.min_updater(db, view, df)
...
if __name__ == "__main__":
    ...
    config_path = r'C:\Users\xinger\Desktop\git\DataSync\config.xlsx'
